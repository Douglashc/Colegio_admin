...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            {path: 'registrar-curso', loadChildren: () =>import('app/modules/admin/modulo-curso/form-registrar-curso/form-registrar-curso.module').then(m => m.FormRegistrarCursoModule)}
        ]
    }
];
